...
::
  ...
  Minimum in x=[-5.  2.  1.  0.] with f(x)=-14.3
...
.. list-table:: List of options
  ...
  *  -  evaluator
     -  <smt.applications.ego.Evaluator object at 0x0000022BB0AC8C90>
     -  None
     -  ['Evaluator']
  ...
  *  -  surrogate
     -  <smt.surrogate_models.krg.KRG object at 0x0000022BB0BAE090>
     -  None
