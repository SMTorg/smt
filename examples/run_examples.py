...
if plot_status:
    ...
    plt.suptitle('Validation of the LS model (from left to right then from top to bottom): validation of the prediction model and the i-th prediction of the derivative---i=1:10')
...
if plot_status:
    ...
    plt.setp(axarr[3, 2].get_xticklabels(), visible=False)
    plt.setp(axarr[3, 2].get_yticklabels(), visible=False)
    plt.suptitle('Validation of the QP model (from left to right then from top to bottom): validation of the prediction model and the i-th prediction of the derivative---i=1:10')
...
if plot_status:
    ...
    plt.setp(axarr[3, 2].get_xticklabels(), visible=False)
    plt.setp(axarr[3, 2].get_yticklabels(), visible=False)
    plt.suptitle('Validation of the Kriging model (from left to right then from top to bottom): validation of the prediction model and the i-th prediction of the derivative---i=1:10')
...
if plot_status:
    ...
    plt.setp(axarr[3, 2].get_xticklabels(), visible=False)
    plt.setp(axarr[3, 2].get_yticklabels(), visible=False)
    plt.suptitle('Validation of the KPLSK model (from left to right then from top to bottom): validation of the prediction model and the i-th prediction of the derivative---i=1:10')
...
if plot_status:
    ...
    plt.setp(axarr[3, 2].get_xticklabels(), visible=False)
    plt.setp(axarr[3, 2].get_yticklabels(), visible=False)
    plt.suptitle('Validation of the GEKPLS1 model (from left to right then from top to bottom): validation of the prediction model and the i-th prediction of the derivative---i=1:10')
...
if plot_status:
    ...
    plt.setp(axarr[3, 2].get_xticklabels(), visible=False)
    plt.setp(axarr[3, 2].get_yticklabels(), visible=False)
    plt.suptitle('Validation of the GEKPLS2 model (from left to right then from top to bottom): validation of the prediction model and the i-th prediction of the derivative---i=1:10')
...
if compiled_available:
    ...
    if plot_status:
        ...
        plt.setp(axarr[3, 2].get_xticklabels(), visible=False)
        plt.setp(axarr[3, 2].get_yticklabels(), visible=False)
        plt.suptitle('Validation of the RBF model (from left to right then from top to bottom): validation of the prediction model and the i-th prediction of the derivative---i=1:10')
    ...
    if plot_status:
        ...
        plt.suptitle('Validation of the RMTB model (from left to right then from top to bottom): validation of the prediction model and the i-th prediction of the derivative---i=1:3')
    ...
    if plot_status:
        ...
        plt.setp(axarr[2, 0].get_xticklabels(), visible=False)
        plt.setp(axarr[2, 0].get_yticklabels(), visible=False)
        plt.suptitle('Validation of the RMTC model (from left to right then from top to bottom): validation of the prediction model and the i-th prediction of the derivative---i=1:3')
