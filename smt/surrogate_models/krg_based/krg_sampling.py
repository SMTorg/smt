"""
Kriging covariance, trajectory sampling, and Karhunen-Loève / Nyström decomposition.

All functions in this module depend on a trained ``KrgBased`` model instance.

Functions
---------
covariance_matrix
    Conditioned or unconditioned covariance matrix.
sample_trajectory
    Sample GP trajectories via eigen- or Cholesky decomposition.
eig_grid
    Karhunen-Loève eigenvalues / eigenvectors via Nyström.
evaluate_eigen_function
    Evaluate Karhunen-Loève eigenfunctions at new points.
sample_eigen
    Sample GP trajectories via Karhunen-Loève / Nyström.
