...
class CoopCompKRG(KrgBased):
    ...
    def train(self, active_coop_comp, comp_var) -> None:
        """Train the model with cooperative component optimization.

        Parameters
        ----------
        active_coop_comp : int
            Index of the active component to optimize.
        comp_var : np.ndarray [nx, n_comp]
            Boolean array mapping design variables to components.
        """
