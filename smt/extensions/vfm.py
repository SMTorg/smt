...
class VFM(Extensions):
    ...
    def _initialize(self):
        ...
        declare('name_model_LF',types=object,values=('KRG','LS','QP','KPLS',
                ...
                'Type of surrogate model for low-fidelity data')
        declare('options_LF',{},types=dict,desc='Options of low-fidelity model')
        declare('name_model_bridge', types=object, values=('KRG','LS','QP','KPLS',
                'KPLSK','GEKPLS','RBF','RMTC','RMTB','IDW'), desc=
                'Type of surrogate model for high-fidelity data; i.e., the bridge function')
        declare('options_bridge', {},types=dict,desc='Options of high-fidelity model')
        ...
        declare('dy_LF', None,types=np.ndarray,desc='Low-fidelity derivative')
        declare('dy_HF', None,types=np.ndarray,desc='High-fidelity derivative')
